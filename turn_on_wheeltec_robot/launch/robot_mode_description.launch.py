...
#BEGIN my code
    ...
    with open(urdf_path, 'r') as f:
        robot_desc = f.read()
        print(f"URDF Path: {urdf_path}")  # Debugging statement
#END my code	
...
#mmmmmmmmmmmmmmmec
    ...
    #END	
        launch_ros.actions.Node(
            ...
            name='robot_state_publisher',
          #BEGIN
            #parameters=[{'robot_description': robot_desc}],),  # Set parameter in node's namespace
          #END
...
#444444444444444444
    ...
    senior_4wd_bs_robot = GroupAction([
        ...
        launch_ros.actions.Node(
            ...
            executable='static_transform_publisher', 
            name='base_to_laser',
            arguments=['0.02', '0', '0.155','0', '0','0','base_footprint','laser'],),
        launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher', 
            name='base_to_camera',
...
#dddddddddddddddddddiff
    ...
    #onze robot is de mecabot x --> top_mec_dl
